...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File "Spikes/Phase0/0.4_ImageSequenceLoadingValidationPerf/Invoke-ImageSequencePerfTest.ps1" -Directory "C:\path\to\tiff_sequence"
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File "Spikes/Phase0/0.4_ImageSequenceLoadingValidationPerf/SelfTest.ps1"
```
